...
function AddIncomeModal({ show, onClose }) {
  ...
  const addIncomeHandler = async (e) => {
    ...
    console.log("Add income handler called");
    console.log("Amount:", amountRef.current.value);
    console.log("Description:", descriptionRef.current.value);
    console.log("User:", user);

    if (!amountRef.current.value || !descriptionRef.current.value) {
    ...
    console.log("New income object:", newIncome);

    try {
      console.log("Calling addIncomeItem...");
